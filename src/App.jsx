...
const BG = {science:'linear-gradient(145deg,#293142,#0b0d12)',bath:'linear-gradient(145deg,#263238,#081014)',broadcast:'linear-gradient(145deg,#2a2638,#09080f)',class:'linear-gradient(145deg,#2a2d36,#090a0f)',hall:'linear-gradient(145deg,#31313a,#090a0f)',dark:'linear-gradient(145deg,#171923,#06070b)'};
const BGNAME = {science:'images/bg-retreat-storage-room.webp',bath:'images/bg-retreat-bathroom.webp',broadcast:'images/bg-retreat-auditorium.webp',class:'images/bg-retreat-room.webp',hall:'images/bg-retreat-hallway.webp',dark:'images/bg-dark.webp'};
const CHAR = {none:'',yubin:'images/char-cha-yubin.webp',taeo:'images/char-kang-taeo.webp',seoyoon:'images/char-han-seoyoon.webp'};
const ENDING_IMG = {
...
const iconMap = {'손에 묻은 피':'images/evidence-blood-hand.webp','뒤통수 상처':'images/evidence-head-wound.webp','깨진 액정 조각':'images/evidence-phone-glass.webp','도윤 팔의 교흔':'images/evidence-bite-mark.webp','서윤 협박 메시지':'images/evidence-seoyoon-threat-message.webp','준비실 쪽 목격담':'images/evidence-seoyoon-hallway-witness.webp'};
...
taeo1:{p:'16',title:'태오',bg:'class',char:'taeo',text:'태오는 벽에 기대 서 있었다.\n\n“왜?”\n“너도 나 의심하냐?”',choices:[['대답한다','choiceTaeo']]},
...
taeoA:{p:'17',title:'태오',bg:'class',char:'taeo',text:'“싸웠지.”\n“걔랑 안 싸운 사람이 있긴 해?”\n\n태오는 당신을 빤히 봤다.\n“플레이어, 너도 걔 싫어했잖아.”',choices:[['다음','yubin2']]},
taeoB:{p:'17',title:'태오',bg:'class',char:'taeo',text:'“마지막?”\n태오는 코웃음을 쳤다.\n\n“그 새끼가 나한테만 시비 턴 줄 알아?”',choices:[['다음','yubin2']]},
taeoC:{p:'17',title:'태오',bg:'class',char:'taeo',text:'“그 말도 기분 더럽네.”\n“너 지금 누구 편 드는 거야?”',choices:[['다음','yubin2']]},
taeoD:{p:'17',title:'태오',bg:'class',char:'taeo',text:'“뭐야.”\n“그 눈깔.”\n\n“너도 뭔가 숨기는 거 있지?”',choices:[['다음','yubin2']]},
    ...
    <div className={`app ${isStart ? "app-main" : ""}`}>
      ...
      {isStart ? (
        <div className="main-start">
          ...
          <div className="scene ending-scene" style={{ "--scene-bg": bg }}>
            <div className="bg">
          ...
          <div className="scene" style={{ "--scene-bg": bg }}>
            ...
            <div className={`char ${ch ? "" : "none"}`}>{ch}</div>
            <div className="card">
              <h2>{scene.title}</h2>
              <p>{fillText(scene.text, state)}</p>
            </div>
