...
유빈은 끝내 당신과 눈을 마주치지 않았다.`,
  ...
  },
  {
    ...
    pages: [
      `“그럼 범인은 강태오네 도윤이랑 사이 안 좋았잖아.”
“나 아니야. 아니라고!”
하지만 이미 강당 안의 시선은 태오에게 꽂혀 있었다.경찰이 태오에게 다가갔다. 그 순간 태오는 뒤로 물러섰다.

태오는 강당 문을 밀치고 뛰쳐나갔다. 끝까지 아니라고 소리치며, 수련원 앞에 세워져 있던 전동 휠에 올라탔다.
경찰은 태오를 쫓았다. 멀어지는 사이렌 소리 속에서, 강당에 남은 사람들은 아무 말도 하지 못했다.
도망친 사람은 더 범인처럼 보였다. 억울한 사람도, 도망치는 순간 그렇게 보였다.`,
    ],
  },
  {
    id: "endSeoyoonFrame",
...
정전 직전 준비실 쪽으로 갔다는 목격담. 도윤에게 협박받고 있었다는 메시지. 그 사실을 숨기려 했던 태도.

혐의가 모이자 너무 그럴듯했다.
경찰은 조사를 위해 서윤을 경찰차에 태웠다. 

"서윤아. 괜찮아. 조사하면 다 밝혀질거야."
유빈이 걱정하듯 말했다.

"자, 이거 쓰고 가. 날이 추우니깐.."
유빈이 서윤에게 털모자를 씌워줬다.. 희미하게 웃어보이며..

그때서야 당신은 깨달았다. 흐린 기억속에서 유빈이 킥킥 웃고 있었다. 그것은
서윤도 피해자라는 증거였다.`,
    ],
  },
  {
    id: "endYubinConfess",
    title: "유빈 자백 와. 너. 정말 엔딩",
    char: "yubin",
    image: "/images/ending-yubin-confess.webp",
    pages: [
      `증거는 점점 차유빈을 향했다.

"깨진 휴대폰. 정전 당시 위치. 도윤 팔의 물린 자국. 그리고 끊겨 있던 내 기억까지. 모든 증거는 다 널 가리키고 있어 차유빈."

“와. 너.."
"정말..핵심을 찔렀어."
유빈의 손끝이 떨렸다. 그 떨림을 본 순간, 당신의 머릿속에 짧은 장면이 스쳤다.

정전. 그때, 도윤의 목소리. 유빈의 울부짖음.

“실수였어.”
“서도윤이 계속 협박을 해서, 내가 깨물었고, 걔 혼자 피하려다 넘어진거야.”
서당이 얼어붙었다. 유빈은 고개를 들었다.

"너희도 알잖아. 서도윤이 어떤 애였는지.”
“여기 서도윤한테서 협박 안 당해본 사람 있어?”

유빈은 숨을 몰아쉬며 소리쳤다. 그 말이 끝나자, 아무도 유빈을 감싸지 않았다. 경찰이 유빈의 손목을 잡았다.
유빈은 끌려가면서도 끝까지 당신을 보지 않았다. 유빈이 마지막까지 두려워한 건 경찰이 아니었다. 당신이 기억을 되찾는 일이었다.`,
    ],
  },
];
...
start:{title:'정전 20분',text:'수련회 첫날 밤. 갑작스런 정전.\n20분 후, 같은 반 서도윤이 죽은 채 발견된다.\n\n그리고 당신은 그의 시체 옆에서 깨어난다.\n손에 묻은 피. 기억은 없다.',start:true},
p1:{p:'1',title:'프롤로그',bg:'science',text:'눈을 떴을 때,\n가장 먼저 보인 건 수련원 준비실 천장이었다.\n머리가 깨질 듯 아팠다.\n\n바닥에는 피를 잔뜩 흘리고 있는 서도윤이 쓰러져 있었다.',choices:[['다음','p2']]},
p2:{p:'2',title:'프롤로그',bg:'science',char:'bloodHand',text:'"야!..서도윤..!"\n도윤을 흔들어 깨웠지만 미동도 없었다..\n손을 내려다보니 피가 묻어 있었다.\n\n“이게..뭐야..?”\n아무것도 기억나지 않았다.\n복도 계단 끝에서 발소리가 느껴진다.\n“...”',choices:[['화장실로 간다','p3',{sus:1,suspect:'player'}]]},
p3:{p:'3',title:'화장실',bg:'bath',text:'세면대 물소리가 화장실 안에 울렸다. 손을 씻었다.\n피는 지워졌고, 머릿속 기억도 여전히 지워진 상태.\n그때 문이 열렸다.',choices:[['다음','p4']]},
...
br1:{p:'8',title:'강당',bg:'broadcast',char:'seoyoon',text:'강당에는 서윤, 태오, 유빈이 모여 있었다.\n서윤이 입을 열었다.\n\n“도윤이 안 보여.”',choices:[['다음','br1_2']]},
br1_2:{p:'8',title:'강당',bg:'broadcast',char:'seoyoon',text:'서윤은 당신 쪽을 봤다.\n“플레이어, 혹시 뭐 아는 거 있어?”\n\n태오가 낮게 웃었다.\n“너 맨날 도윤이 옆에 붙어 다녔잖아.”',choices:[['다음','br2']]},
br2:{p:'9',title:'강당',bg:'broadcast',char:'seoyoon',text:'서윤이 다시 물었다.\n\n“솔직히 다들 너부터 떠올렸어. 도윤이랑 친하니까.”\n\n“마지막으로 언제 봤어?”',choices:[['대답한다','choiceLast']]},
choiceLast:{title:'어떻게 할까?',bg:'broadcast',char:'seoyoon',choices:[['마지막으로 같이 있었다고 말한다.','lastA',{truth:1,sus:2}],['아무 말도 하지 않는다.','lastB',{suspect:'player',lie:1,sus:1}],['몰라. 도윤이 어딨는데?','lastC',{sus:1}],['다른 사람들 반응을 본다.','lastD',{truth:1}]]},
lastA:{p:'10',title:'강당',bg:'broadcast',char:'seoyoon',text:'“..같이 있었어.”\n\n순간 강당이 조용해졌다.\n누군가 아주 작게 숨을 들이켰다.\n\n도윤과 붙어 다니던 당신이, 마지막으로 도윤과 있었다.\n그 사실만으로 강당 안의 공기가 당신 쪽으로 기울었다.',choices:[['다음','teacher']]},
...
biteEvidence:{p:'15',title:'증거',bg:'science',text:'도윤의 팔에 물린 자국이 있었다.\n\n정전 중, 도윤은 누군가와 몸싸움을 한것 같다.',choices:[['다음','taeo1']]},
noEvidence:{p:'15',title:'현장',bg:'science',text:'더 보지 않았다.\n\n보면 볼수록, 내가 더 위험해질 것 같았다.',choices:[['다음','taeo1']]},
taeo1:{p:'16',title:'태오',bg:'hall',char:'taeo',text:'태오는 벽에 기대 서 있었다.\n\n“왜?”\n“너도 나 의심하냐?”',choices:[['대답한다','choiceTaeo']]},
choiceTaeo:{title:'태오에게 뭐라고 할까?',bg:'hall',char:'taeo',choices:[['너 도윤이랑 싸웠잖아.','taeoA',{suspect:'taeo',wrong:2}],['도윤이랑 마지막으로 무슨 얘기 했어?','taeoB',{suspect:'taeo',truth:1}],['넌 범인 아닌 것 같아.','taeoC',{truth:1}],['아무 말 없이 본다.','taeoD',{suspect:'player',sus:1}]]},
taeoA:{p:'17',title:'태오',bg:'hall',char:'taeo',text:'“싸웠지.”\n“걔랑 안 싸운 사람이 있긴 해?”\n\n태오는 당신을 빤히 봤다.\n“너도 걔한테 약점 잡힌 거 하나쯤은 있을 거 아냐.”',choices:[['다음','yubin2']]},
taeoB:{p:'17',title:'태오',bg:'hall',char:'taeo',text:'“마지막?”\n태오는 코웃음을 쳤다.\n\n“그 새끼가 나한테만 시비 턴 줄 알아?”\n“애들 약점 하나씩 잡고, 웃으면서 돌려 말하는 거 좋아했잖아.”\n\n태오의 목소리가 낮아졌다.\n“오늘도 누군가 하나는 울릴 생각이었겠지.”\n\n그 말에 몇몇 아이들이 고개를 돌렸다.\n태오의 분노가 이해되는 순간, 오히려 태오가 더 위험해 보였다.',choices:[['다음','yubin2']]},
taeoC:{p:'17',title:'태오',bg:'hall',char:'taeo',text:'“그 말도 기분 더럽네.”\n“너 지금 누구 편 드는 거야?”\n\n태오는 당신을 노려봤다.\n당신이 감싸려 할수록, 태오의 날 선 반응은 더 눈에 띄었다.',choices:[['다음','yubin2']]},
taeoD:{p:'17',title:'태오',bg:'hall',char:'taeo',text:'“뭐야.”\n“그 눈깔.”\n\n“너도 뭔가 숨기는 거 있지?”',choices:[['다음','yubin2']]},
yubin2:{p:'18',title:'유빈',bg:'hall',char:'yubin',text:'유빈의 휴대폰 화면이 켜지자 지직거렸다.\n액정 한쪽이 깨져 있었고 화면이 망가져 나오지 았았다.\n\n당신은 수련원 준비실 바닥의 액정 조각을 떠올렸다.',choices:[['어떻게 할까?','choiceYubin2']]},
